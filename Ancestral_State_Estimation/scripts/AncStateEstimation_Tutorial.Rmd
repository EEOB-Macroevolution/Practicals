...
This function performs stochastic mapping using several different methods. Essentially, given a model for character evolution, it simulates histories under the model. The function has many parameters and modes, we will be using the "empirical" uses the following arguments
...
<div class = "try">
#### Ancestral state estimates of Anolis
